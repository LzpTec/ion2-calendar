...
export declare class MonthPickerComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDefWithMeta<MonthPickerComponent, "ion-calendar-month-picker", never, { "month": "month"; "color": "color"; "monthFormat": "monthFormat"; }, { "select": "select"; }, never, never>;
}
